# DS-Learn
[![NPM](https://img.shields.io/npm/l/react)](https://github.com/mora3s-victor/ds-learn/blob/master/LICENSE) 
...
## Modelo conceitual
![Modelo Conceitual](https://github.com/mora3s-victor/assets/blob/master/img/dslearn/modelo-conceitual.png)
...
```bash
# clonar repositório
git clone https://github.com/mora3s-victor/ds-learn.git
